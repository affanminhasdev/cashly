...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF492065);
  late Color secondary = const Color(0xFFC10E73);
  late Color tertiary = const Color(0xFFF5F5F5);
  late Color alternate = const Color(0xFFE6EBF6);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFB7B7B7);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xCD492065);
