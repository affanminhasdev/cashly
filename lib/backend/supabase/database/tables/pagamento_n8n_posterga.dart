...
class PagamentoN8nPostergaTable extends SupabaseTable<PagamentoN8nPostergaRow> {
  @override
  String get tableName => 'pagamento_n8n_posterga';

  @override
  PagamentoN8nPostergaRow createRow(Map<String, dynamic> data) =>
      PagamentoN8nPostergaRow(data);
}

class PagamentoN8nPostergaRow extends SupabaseDataRow {
  PagamentoN8nPostergaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PagamentoN8nPostergaTable();
