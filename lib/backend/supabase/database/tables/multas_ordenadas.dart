...
class MultasOrdenadasTable extends SupabaseTable<MultasOrdenadasRow> {
  @override
  String get tableName => 'multas_ordenadas';

  @override
  MultasOrdenadasRow createRow(Map<String, dynamic> data) =>
      MultasOrdenadasRow(data);
}

class MultasOrdenadasRow extends SupabaseDataRow {
  MultasOrdenadasRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MultasOrdenadasTable();
  ...
  DateTime? get dataInfracaoTimestamp =>
      getField<DateTime>('data_infracao_timestamp');
  set dataInfracaoTimestamp(DateTime? value) =>
      setField<DateTime>('data_infracao_timestamp', value);
}
