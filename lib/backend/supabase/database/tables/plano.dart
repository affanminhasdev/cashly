...
class PlanoTable extends SupabaseTable<PlanoRow> {
  @override
  String get tableName => 'plano';

  @override
  PlanoRow createRow(Map<String, dynamic> data) => PlanoRow(data);
}

class PlanoRow extends SupabaseDataRow {
  PlanoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PlanoTable();
