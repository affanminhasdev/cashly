...
class PagamentoN8nHojeTable extends SupabaseTable<PagamentoN8nHojeRow> {
  @override
  String get tableName => 'pagamento_n8n_hoje';

  @override
  PagamentoN8nHojeRow createRow(Map<String, dynamic> data) =>
      PagamentoN8nHojeRow(data);
}

class PagamentoN8nHojeRow extends SupabaseDataRow {
  PagamentoN8nHojeRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PagamentoN8nHojeTable();
