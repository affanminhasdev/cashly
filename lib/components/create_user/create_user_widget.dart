                                  ...
                                  onTap: () async {
                                    ...
                                    if (_colorPickedColor != null) {
                                      safeSetState(() => _model.colorPicked =
                                          _colorPickedColor.applyAlpha(1.0));
                                    }

                                    safeSetState(() {
                                      _model.corTextController?.text = functions
                                          .returnColor(_model.colorPicked!);
                                    });
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    ...
                                    Expanded(
                                      child: FutureBuilder<List<RolesRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<RolesRow> dropDownRolesRowList =
                                              snapshot.data!;
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.textController4.text ==
                            ...
                            _model.user =
                                await SupabaseGroup.criarUsuarioCall.call(
                              email: _model.textController2.text,
                              senha: _model.textController4.text,
                              nome: _model.textController1.text,
                              role: _model.dropDownValue,
                              cor: _model.corTextController.text,
                            );
